...
14. [Добавление функций и изменение поведения](#adding-new-features-and-modifying-functionality)
15. [Обратная совместимость](#backward-compatibility-guidelines)
16. [Pull request и код-ревью](#pull-request-process-and-code-review-standards)
17. [Стандарты документации](#documentation-standards)
18. [Сообщения коммитов](#commit-message-conventions)
19. [Выпуск релизов](#release-procedures)
20. [Отладка, профилирование и оптимизация](#debugging-profiling-and-performance-optimization)
21. [Заключение](#conclusion)
