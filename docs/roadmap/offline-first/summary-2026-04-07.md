...
**Specification Document:** `docs/roadmap/offline-first/backend-idempotency-implementation.md`
...
Guides:
1. `docs/roadmap/offline-first/implementation-plan-2026-04-07.md`
2. `docs/roadmap/offline-first/backend-idempotency-implementation.md`
3. `docs/roadmap/offline-first/deployment-guide-2026-04-07.md`
