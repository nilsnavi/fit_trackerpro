...
| Exercises `/exercises/*` | 10/11 | Нет модерации `POST /{id}/approve` (P1-4) |
...
| Achievements | 4/5 | ОК |
| Challenges | 1/7 | Только список; нет join/leave/leaderboard/своих (P1-3) |
| Emergency `/system/emergency/*` | 7/12 | Нет редактирования контакта, настроек, уведомлений о начале/конце тренировки (P1-2) |
